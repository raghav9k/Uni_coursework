; timer0_blink_1sec.asm
; CSC 230 - Summer 2018
; 
; This code uses timer 0 (see datasheet) to blink the LED on pin 52 (port B bit 1)
; at regular intervals. In this version, the LED blinks after every 61 interrupts.
; With a prescalar value of 1024 and a clock speed of 16Mhz, this results in 
;      16000000/1024/256/61 = 1.0005 blinks per second
; or one blink every
;      1/1.0005 = 0.994 seconds
; (which is close enough to 1 second accuracy for assignment 2)
;
