...
{	
	...
	constexpr Sphere sph1 = { {500,100,100}, 60, {1,0,0} };
	constexpr Sphere sph2 = { {200,100,0} ,10, {2,4,0} };
	constexpr Sphere sph3 = { {400,400,50}, 40, {2,0,1} };
	constexpr Sphere sph4 = { {440,300,200}, 50, {1,6,1} };
	constexpr Sphere sph5 = { {100,500,20}, 30, {0,1,0} };
	constexpr Sphere sph6 = { {400,100,20}, 40, {2,2,2} };
	...
	std::vector<Colour> imageS{ 600 * 600 };
