...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref v2.0-rc1
  WORKING_DIRECTORY "H:/CSC305/a3_2/build/_deps/tinyobjloader-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.0-rc1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.0-rc1")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "v2.0-rc1")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v2.0-rc1
  WORKING_DIRECTORY "H:/CSC305/a3_2/build/_deps/tinyobjloader-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/syoyo/tinyobjloader.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/CSC305/a3_2/build/_deps/tinyobjloader-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/CSC305/a3_2/build/_deps/tinyobjloader-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
