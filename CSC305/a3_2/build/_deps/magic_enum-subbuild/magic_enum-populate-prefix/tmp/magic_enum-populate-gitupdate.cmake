...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref v0.6.4
  WORKING_DIRECTORY "H:/CSC305/a3_2/build/_deps/magic_enum-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v0.6.4")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v0.6.4")
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v0.6.4
  WORKING_DIRECTORY "H:/CSC305/a3_2/build/_deps/magic_enum-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/Neargye/magic_enum'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/CSC305/a3_2/build/_deps/magic_enum-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/CSC305/a3_2/build/_deps/magic_enum-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
