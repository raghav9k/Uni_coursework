...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref 0.9.9.7
  WORKING_DIRECTORY "H:/CSC305/labs/build/_deps/glm-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0.9.9.7")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0.9.9.7")
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 0.9.9.7
  WORKING_DIRECTORY "H:/CSC305/labs/build/_deps/glm-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/CSC305/labs/build/_deps/glm-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/CSC305/labs/build/_deps/glm-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
